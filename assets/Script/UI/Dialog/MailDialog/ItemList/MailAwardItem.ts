...
@ccclass
export default class MailAwardItem extends Item<MailAwardData> {

    private _data: MailAwardData;
    ...
    bindData(currentIndex: number, data: MailAwardData) {
